%------------------------------------------------------------------------------
% File     : SCT002-1 : TPTP v9.2.1. Released v4.1.0.
% Domain   : Social Choice Theory
% Problem  : Arrow Order 044_1
% Version  : Especial.
...
% Source   : [Nip10]
% Names    : Arrow_Order-044_1 [Nip10]

% Status   : Unsatisfiable
% Rating   : 0.09 v9.1.0, 0.10 v8.1.0, 0.11 v7.4.0, 0.06 v7.3.0, 0.00 v7.0.0, 0.20 v6.3.0, 0.09 v6.2.0, 0.20 v6.1.0, 0.29 v6.0.0, 0.30 v5.5.0, 0.45 v5.3.0, 0.44 v5.2.0, 0.38 v5.1.0, 0.47 v5.0.0, 0.43 v4.1.0
% Syntax   : Number of clauses     :  677 ( 204 unt;  71 nHn; 368 RR)
%            Number of literals    : 1423 ( 310 equ; 693 neg)
%            Maximal clause size   :    6 (   2 avg)
%            Maximal term depth    :    7 (   1 avg)
%            Number of predicates  :   32 (  31 usr;   0 prp; 1-6 aty)
%            Number of functors    :   88 (  88 usr;  11 con; 0-7 aty)
%            Number of variables   : 2377 ( 215 sgn)
