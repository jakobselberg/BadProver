%------------------------------------------------------------------------------
% File     : NUM001-1 : TPTP v9.2.1. Released v1.0.0.
...
% Source   : [SPRFN]
% Names    : Example 10a [Cha70]
%          : ls28 [LS74]
%          : ls28 [WM76]

% Status   : Unsatisfiable
% Rating   : 0.00 v5.4.0, 0.06 v5.3.0, 0.10 v5.2.0, 0.08 v5.1.0, 0.06 v5.0.0, 0.00 v2.2.1, 0.22 v2.1.0, 0.00 v2.0.0
