%--------------------------------------------------------------------------
% File     : LCL002-1 : TPTP v9.2.1. Released v1.0.0.
% Domain   : Logic Calculi (Disjunction/Negation 2 valued sentential)
% Problem  : AN-CAMeredith => AN-1
...
%            AN-4}. Show that AN-1 can be derived from the Meredith axiom.
...
% Rating   : 0.35 v9.1.0, 0.47 v9.0.0, 0.18 v8.2.0, 0.14 v8.1.0, 0.00 v7.4.0, 0.17 v7.3.0, 0.00 v6.2.0, 0.33 v6.1.0, 0.64 v6.0.0, 0.44 v5.5.0, 0.62 v5.4.0, 0.61 v5.3.0, 0.70 v5.2.0, 0.62 v5.1.0, 0.69 v5.0.0, 0.60 v4.1.0, 0.67 v4.0.1, 0.29 v3.4.0, 0.20 v3.3.0, 0.00 v3.2.0, 0.33 v3.1.0, 0.50 v2.7.0, 0.75 v2.6.0, 0.71 v2.4.0, 0.86 v2.3.0, 0.71 v2.2.1, 0.89 v2.1.0, 1.00 v2.0.0
