%--------------------------------------------------------------------------
% File     : ANA002-1 : TPTP v9.2.1. Bugfixed v1.0.1.
% Domain   : Analysis
...
% Rating   : 0.77 v9.1.0, 0.64 v9.0.0, 0.58 v8.2.0, 0.29 v7.5.0, 0.50 v7.4.0, 0.33 v7.1.0, 0.50 v6.4.0, 0.62 v6.3.0, 0.57 v6.2.0, 0.44 v6.1.0, 0.43 v6.0.0, 0.57 v5.5.0, 0.75 v5.4.0, 0.80 v5.1.0, 0.73 v5.0.0, 0.64 v4.1.0, 0.50 v4.0.1, 0.80 v4.0.0, 0.57 v3.4.0, 0.50 v3.3.0, 0.33 v2.7.0, 0.38 v2.6.0, 0.67 v2.5.0, 0.60 v2.4.0, 0.80 v2.3.0, 1.00 v2.0.0
% Syntax   : Number of clauses     :   18 (   5 unt;   5 nHn;  14 RR)
