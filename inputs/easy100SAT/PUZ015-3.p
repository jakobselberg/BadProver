%--------------------------------------------------------------------------
% File     : PUZ015-3 : TPTP v9.2.1. Released v2.7.0.
% Domain   : Puzzles
...
% Status   : Satisfiable
% Rating   : 0.00 v8.2.0, 0.33 v8.1.0, 0.67 v7.5.0, 0.33 v7.1.0, 0.67 v7.0.0, 0.33 v6.2.0, 1.00 v6.1.0, 0.67 v5.5.0, 0.75 v5.4.0, 0.89 v5.3.0, 0.86 v5.0.0, 0.88 v4.1.0, 0.86 v4.0.0, 0.88 v3.5.0, 0.86 v3.4.0, 0.83 v3.2.0, 0.80 v3.1.0, 0.86 v2.7.0
% Syntax   : Number of clauses     :   32 (  17 unt;   0 nHn;  17 RR)
%            Number of literals    :   62 (   0 equ;  31 neg)
%            Maximal clause size   :    3 (   1 avg)
%            Maximal term depth    :    2 (   1 avg)
%            Number of predicates  :    3 (   3 usr;   0 prp; 2-8 aty)
%            Number of functors    :    3 (   3 usr;   2 con; 0-8 aty)
