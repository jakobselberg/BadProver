%--------------------------------------------------------------------------
% File     : TOP002-1 : TPTP v9.2.1. Released v1.0.0.
% Domain   : Topology
...
% Status   : Satisfiable
% Rating   : 0.00 v5.5.0, 0.25 v5.4.0, 0.89 v5.3.0, 0.71 v5.0.0, 0.50 v4.1.0, 0.43 v4.0.0, 0.50 v3.5.0, 0.57 v3.4.0, 0.83 v3.2.0, 0.80 v3.1.0, 0.71 v2.7.0, 0.80 v2.6.0, 0.75 v2.5.0, 0.83 v2.4.0, 1.00 v2.0.0
...
%--------------------------------------------------------------------------
cnf(lemma_1b_1,negated_conjecture,
    basis(cx,f) ).
